...
class Ui_NoteWidget(object):
    def setupUi(self, NoteWidget):
        ...
        self.titleEdit = QtWidgets.QLineEdit(NoteWidget)
        self.titleEdit.setObjectName("titleEdit")
        self.horizontalLayout_2.addWidget(self.titleEdit)
        self.pushButton = QtWidgets.QPushButton(NoteWidget)
    ...
    def retranslateUi(self, NoteWidget):
        ...
        self.pushButton.setText(_translate("NoteWidget", "Edit labels"))
